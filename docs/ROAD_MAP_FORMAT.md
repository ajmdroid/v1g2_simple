...
road-snapping on the ESP32, with optional ALPR camera overlay.
...
**Cameras**: ALPR/speed camera points from PostGIS enrichment  
...
| 10     | 1    | uint8  | `flags`    | Camera type flags |
