...
## Project Rails
- All work happens on `dev-refactor`. Do NOT create feature branches.
- Do not work in `main`.
...
- ./build.sh --clean --all -n   # Build everything, upload, no monitor
- ./build.sh --all -n           # Same without clean
