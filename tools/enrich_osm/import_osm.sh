...
echo ""
echo "Next steps:"
echo "  1. Load cameras: ./load_camera_ndjson_to_pg.py ../../camera_data/alpr.json"
...
echo "  3. Export: ./export_and_merge.py --table cameras_enriched --output ../../camera_data_enriched/alpr.json"
echo ""
