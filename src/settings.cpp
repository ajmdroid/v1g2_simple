...
void SettingsManager::load() {
    ...
    settings.cameraAlertRangeM = clampCameraAlertRangeMValue(
        preferences.getUShort("camRngM", CAMERA_ALERT_RANGE_M_DEFAULT));
    ...
    settings.cameraVoiceEnabled = preferences.getBool("camVoice", true);
    settings.cameraVoiceClose = preferences.getBool("camVClose", true);
