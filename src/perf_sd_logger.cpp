...
bool PerfSdLogger::appendSnapshotLine(const PerfSdSnapshot& snapshot) {
    ...
    const bool ok =
        ...
        appendCsvUInt32(line, sizeof(line), offset, snapshot.preQuietDropCount) &&
        appendCsvUInt32(line, sizeof(line), offset, snapshot.preQuietRestoreCount) &&
        appendCsvUInt32(line, sizeof(line), offset, snapshot.preQuietRestoreRetryCount) &&
